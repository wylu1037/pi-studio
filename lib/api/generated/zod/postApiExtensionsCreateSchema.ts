 ...
 * @description OK
 */
export const postApiExtensionsCreate200Schema = z.object({
    "id": z.string(),
"name": z.string(),
"path": z.string(),
 ...
 * @description OK
 */
export const postApiExtensionsCreate400Schema = z.object({
    "error": z.string()
    })
...
export const postApiExtensionsCreateMutationResponseSchema = z.lazy(() => postApiExtensionsCreate200Schema)